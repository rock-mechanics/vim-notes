...
#include<assert.h> // this gives us assert function which crash if condition is not true
...
int main(int argc, char* argv[])
{
	...
	// let's try to free frank and then access it again to see what happens.
	Person_print(frank);
